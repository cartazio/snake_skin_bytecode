...
Repeat `--select` to recover multiple code objects. Exact recovery either prints
a complete CFG or returns a nonzero status with the unsupported bytecode
operation and offset. Partial inspection is not presented as exact recovery.
